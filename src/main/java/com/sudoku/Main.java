...
public class Main {
    ...
    public static void main(String [] args) {
        ...
        sudokuGame.getSudokuBoard().getGameBoard().get(0).getSingleRow().get(0).setValueBoard(1);
        sudokuGame.getSudokuBoard().getGameBoard().get(1).getSingleRow().get(0).setValueBoard(2);
        sudokuGame.getSudokuBoard().getGameBoard().get(0).getSingleRow().get(1).setValueBoard(3);
